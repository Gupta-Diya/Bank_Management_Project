...
public:
    void readData(string c_name, string account, float c_amount, string c_acctype = "saving") 
    ...
    void deposite(float c_amount) 

    {
        amount += c_amount;
    }
    void withdraw(float c_amount) 
    ...
    void maturity_amount(int w_date, int w_month, int w_year) 
    {
    ...
    void getData(string c_name, string account, int c_date, int c_month, int c_year, float c_amt, string c_acctype = "recurrance deposite")
